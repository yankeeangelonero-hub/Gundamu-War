...
@export var feel: Dictionary = {
	"max_speed": [192.0, 28.0],   # by HEFT: cruise cap — FAST suits dart (3x of old 64), heavy still lumbers
	"max_accel": [102.0, 10.0],   # by HEFT: accel — fast suits snap up to speed (3x), heavy ramps slowly
